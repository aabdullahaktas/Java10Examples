...
public class Kosucu implements Runnable {
	...
	private int adimMesafesi;
	
	
	public Kosucu(String isim,long baslangicZamani,int adimMesafesi) {
		super();
		this.isim = isim;
		this.baslangicZamani = baslangicZamani;
		this.adimMesafesi = adimMesafesi;
	}
	...
	public void run() {
		...
		System.out.println(isim+" adlı kosucu 100 metreyi "+sure+" ms kosmustur");
