...
public class Runner {
	...
	public static void main(String[] args) {
		...
		Pokemon suPokemonu = new SuPokemon(2, "squirtle", 500, 100, 2, 250, 368);
		ElektrikPokemon elektrikPokemonu = new ElektrikPokemon(3, "pikhachu", 180, 200, 2, 1280);
	...
	public static void saldir2(Pokemon pokemon) {
		...
		} else if (pokemon instanceof SuPokemon) {
